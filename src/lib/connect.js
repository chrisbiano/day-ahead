 ...
 *
 * DELIBERATELY ABSENT: gmail.settings.basic. It was here to read the send-as
 * signature, but it is RESTRICTED, and Google weighs what a scope PERMITS rather
 * than what an app does with it — settings.basic allows changing filters,
 * forwarding and vacation responders. Requesting write access to someone's mail
 * settings in order to read one string enlarges the CASA security assessment and
 * invites a reviewer's question we would rather not have to answer. Signatures
 * are pasted into Settings instead and stored per account.
 *
